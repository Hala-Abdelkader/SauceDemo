...
public class ProductsPage {
    ...
    /**
     * Locate the WebElement for the product name "Sauce Labs Onesie".
     */
 ...
 * This method first sorts the products by price low to high,
 * waits for 1 second to ensure sorting is complete,
 * then selects the product and adds it to the cart.
 */
      public void AddLowestProductToCart() throws InterruptedException {
